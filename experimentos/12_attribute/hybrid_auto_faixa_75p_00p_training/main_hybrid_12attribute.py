...
hybrid_classifier.setPercentilFaixaSup(75)
hybrid_classifier.setPercentilFaixaInf(00)
...
cross.setResultPath("../../../results/12_attribute/hybrid_auto_faixa_75p_00p_training/")

...
hybrid_classifier.setPercentilFaixaSup(50)
hybrid_classifier.setPercentilFaixaInf(85)
...
cross.setResultPath("../../../results/complete_attribute/hybrid_auto_faixa_85p_50p_training/")

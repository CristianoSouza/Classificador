...
hybrid_classifier.setLowerThreshold(-0.9)
hybrid_classifier.setUpperThreshold(0.9)
...
cross.setResultPath("../../../results/complete_attribute/hybrid_09_oculta42_knnbrute_time_melhorado_tentando2/")
